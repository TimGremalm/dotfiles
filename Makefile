...
packages_development = git gitk meld python3 python3-pip python3-dev ipython3 python3-numpy python3-dbus python3-pytest setuptools cmake ninja-build autoconf libtool
